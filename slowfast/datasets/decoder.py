...
def pyav_decode(
    ...
    if container.streams.video:
        ...
        container.close()
        # Build frame indices robustly. Some PyAV frames may not expose `.index`.
        # Fall back to sequential indices to avoid NoneType issues.
        _indices = []
        ...
        frames_idx = torch.tensor(_indices, dtype=torch.long)
...
def decode(
    ...
    try:
        ...
        return (None, None) if get_frame_idx else None
